...
enum ixgbe_state_t {
	...
	__IXGBE_DISABLED = 4,
	__IXGBE_REMOVING = 5,
	__IXGBE_SERVICE_SCHED = 6,
	__IXGBE_SERVICE_INITED = 7,
	__IXGBE_IN_SFP_INIT = 8,
	__IXGBE_PTP_RUNNING = 9,
	__IXGBE_PTP_TX_IN_PROGRESS = 10,
	__IXGBE_RESET_REQUESTED = 11,
};
...
int ixgbe_mdio_write(struct net_device *netdev, int prtad, int devad,
                     u16 addr, u16 value);
void ixgbe_set_eee_capable(struct ixgbe_adapter *adapter);
bool ixgbe_check_fw_error(struct ixgbe_adapter *adapter);
void ixgbe_set_fw_version(struct ixgbe_adapter *adapter);
...
/* Functions from ixgbe_x550 */
void ixgbe_set_mdio_speed(struct ixgbe_hw *hw);
s32 ixgbe_init_ext_t_x550em(struct ixgbe_hw *hw);
void ixgbe_setup_mux_ctl(struct ixgbe_hw *hw);

/* Functions from ixgbe_phy */
s32 ixgbe_mii_bus_read_generic_c45(struct ixgbe_hw *hw, int addr,
                                   int devad, int regnum, u32 gssr);
s32 ixgbe_mii_bus_write_generic_c22(struct ixgbe_hw *hw, int addr,
                                    int regnum, u16 val, u32 gssr);
s32 ixgbe_mii_bus_write_generic_c45(struct ixgbe_hw *hw, int addr,
                       int devad, int regnum, u16 val,
                                    u32 gssr);
s32 ixgbe_mii_bus_read_c22(struct mii_bus *bus, int addr, int regnum);
s32 ixgbe_mii_bus_read_generic_c22(struct ixgbe_hw *hw, int addr,
                                   int regnum, u32 gssr);

/* Functions from IntelLucyHardware */
